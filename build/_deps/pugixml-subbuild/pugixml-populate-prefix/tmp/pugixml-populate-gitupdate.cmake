...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" show-ref "v1.10"
  WORKING_DIRECTORY "D:/Work/TSP2A/C++/RuinsOfScience/build/_deps/pugixml-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/v1.10")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "v1.10")
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/zeux/pugixml.git'")
  endif()
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: 'D:/Work/TSP2A/C++/RuinsOfScience/build/_deps/pugixml-src'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/Work/TSP2A/C++/RuinsOfScience/build/_deps/pugixml-src'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
